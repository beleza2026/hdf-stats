              ...
              return Column(
                ...
                children: [
                  ...
                  ...equipos.asMap().entries.map((entry) {
                    ...
                    return _tablaRow(i.toString(), eq['team']['name'], pj, g, e, p, pts);
                  }),
                  const SizedBox(height: 16),
                ],
              );
          ...
          children: [
            ...zonas.entries.where((z) => z.key == 'Zona A' || z.key == 'Zona B').map((zona) {
              ...
              final tabla = equipos.map((eq) {
                ...
                return {'nombre': eq['team']['name'], 'pts': pts, 'forma': ultimos.reversed.toList()};
              }).toList();
        ...
        return ListView(
          ...
          children: [
            ...
            ...arqueros.asMap().entries.map((entry) {
              ...
              return _arqueroCard((i + 1).toString(), player['name'], stats['team']['name'], golesConcedidos.toString(), promedio, partidosJugados.toString());
            }),
          ],
        );
      },
            ...
            return ListView(
              ...
              children: [
                ...
                if (jugado && fixtureId != null) ...[
                        ...
                        return Container(
                          ...
                          child: Row(children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(color: rating >= 7.5 ? Colors.green : rating >= 6.5 ? const Color(0xFFFF9800) : Colors.red, borderRadius: BorderRadius.circular(4)),
                  ...
                  _historialRow(local, '2-1', visitante, 'Gano local'),
                  _historialRow(visitante, '1-1', local, 'Empate'),
                  _historialRow(local, '0-1', visitante, 'Gano visitante'),
                  const SizedBox(height: 16),
                  _detalleSeccion('PREDICCION HDF STATS'),
                  Container(
                    padding: const EdgeInsets.all(14),
                    decoration: BoxDecoration(color: const Color(0xFF00C853).withValues(alpha: 0.1), borderRadius: BorderRadius.circular(10), border: Border.all(color: const Color(0xFF00C853).withValues(alpha: 0.3))),
                    child: const Text('Prediccion proxima version', style: TextStyle(color: Color(0xFF00C853), fontSize: 12), textAlign: TextAlign.center),
                  ),
                ],
              ],
            );
      ...
      return Column(mainAxisSize: MainAxisSize.min, children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            image: p['player']['photo'] != null ? DecorationImage(image: NetworkImage(p['player']['photo'] as String), fit: BoxFit.cover) : null,
